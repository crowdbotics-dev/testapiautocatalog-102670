...
## Project Structure
    ...
    ├── testapiautocatalog_102670  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_102670`
...
2. Clone this repo and `cd testapiautocatalog_102670`
